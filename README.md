...
ZonExp — это интерактивная веб-платформа, в которой город Красноярск становится RPG-пространством личного роста, где реальные действия (прохождения квестов на основе геолокации) усиливают персонажа и открывают заблокированные территории. Пользователи могут исследовать карту, выполнять задачи и получать награды.
...
- 🤝 **Интеграция с CRM** — Двусторонняя синхронизация с Bitrix24 (контакты, прогресс, техподдержка)
...
### Техподдержка и CRM
- `POST /api/support` — Отправить обращение в техподдержку (создает задачу в Bitrix24)
...
| **Bitrix24 REST API** | CRM-система, управление контактами и задачами |
